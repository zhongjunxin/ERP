...
public class Purchasereturns extends BaseEntity
{
    ...
    /** 关联采购入库单号 */
    @Excel(name = "关联采购入库单号")
    private Long relatedIncomingId;
    ...
    public void setRelatedIncomingId(Long relatedIncomingId) 
    {
        this.relatedIncomingId = relatedIncomingId;
    }

    public Long getRelatedIncomingId() 
    {
        return relatedIncomingId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("relatedIncomingId", getRelatedIncomingId())
